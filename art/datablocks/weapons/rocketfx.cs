...
datablock SphereEmitterData(RocketDebrisTrailEmitter)
{
...
datablock SphereEmitterData(RocketSplashMistEmitter)
{
   ejectionPeriodMS = 5;
   periodVarianceMS = 0;
...
datablock SphereEmitterData(RocketSplashRingEmitter)
{
   lifetimeMS = "100";
...
datablock SphereEmitterData(RocketExpFireEmitter)
{
   ejectionPeriodMS = "10";
   periodVarianceMS = "5";
   ejectionVelocity = "3";
...
datablock SphereEmitterData(RocketExpFireballEmitter)
{
...
datablock SphereEmitterData(RocketExpSmokeEmitter)
{
   ejectionPeriodMS = "15";
   periodVarianceMS = "5";
   //ejectionOffset = "1";
...
datablock SphereEmitterData(RocketExpSparksEmitter)
{
...
datablock SphereEmitterData(RocketExpSubFireEmitter)
{
...
datablock SphereEmitterData(RocketExpSubSmokeEmitter)
{

...
{
   mapTo = "palm_bark";
   diffuseMap[0] = "art/packs/Forests/trees/palm/palmbark_diffuse";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/palm/palmbark_normal.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/palm/palmbark_normal_specular.dds";
   useAnisotropic[0] = "1";
   showFootprints = "0";
};
...
{
   mapTo = "palm_fronds";
   diffuseMap[0] = "art/packs/Forests/trees/palm/palmfrond_diffuse_transparency";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/palm/palmfrond_normal_specular.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/palm/palmfrond_specular.dds";
   useAnisotropic[0] = "1";
   alphaTest = "1";
   alphaRef = "127";
   showFootprints = "0";

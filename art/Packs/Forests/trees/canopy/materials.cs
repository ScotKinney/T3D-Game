...
{
   mapTo = "canopytree_fronds_lodhi";
   diffuseMap[0] = "art/Packs/Forests/trees/canopy/canopytree_fronds_diffuse_transparency";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/canopy/canopytree_fronds_normal_specular.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/canopy/canopytree_fronds_specular.dds";
   useAnisotropic[0] = "1";
   alphaTest = "1";
   alphaRef = "73";
   showFootprints = "0";
...
{
   mapTo = "canopytree_extras_lodhi";
   diffuseMap[0] = "art/packs/Forests/Trees/Canopy/canopytree_extras_diffuse_transparency";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/canopy/canopytree_extras_normal_specular.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/canopy/canopytree_extras_specular.dds";
   useAnisotropic[0] = "1";
   alphaTest = "1";
   alphaRef = "33";
   showFootprints = "0";
...
{
   mapTo = "canopytree_bark_lodhi";
   diffuseMap[0] = "art/packs/Forests/Trees/Canopy/canopytree_bark_diffuse";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/canopy/canopytree_bark_normal_specular.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/canopy/canopytree_bark_specular.dds";
   useAnisotropic[0] = "1";
   showFootprints = "0";
};
...
{
   mapTo = "canopytree_lodlo";
   diffuseMap[0] = "art/packs/Forests/Trees/Canopy/canopytree_diffuse_transparency";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "1";
   translucentBlendOp = "None";
   useAnisotropic[0] = "1";
...
singleton Material(canopytree_two_canopytree_barkflat_lodhi)
{
   ...
   specularPower[0] = "128";
   translucentBlendOp = "None";
   normalMap[0] = "art/Packs/Forests/trees/canopy/canopytree_bark_normal.dds";
   pixelSpecular[0] = "1";
   specularMap[0] = "art/Packs/Forests/trees/canopy/canopytree_bark_specular.dds";
   useAnisotropic[0] = "1";
   showFootprints = "0";

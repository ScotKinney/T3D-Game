...
{
   filename = "art/Packs/Precip/rain/sound/amb";
...
datablock PrecipitationData(HeavyRain)
{
   ...
   dropTexture = "art/Packs/Precip/rain/rain";
   splashTexture = "art/Packs/Precip/rain/water_splash";
   dropSize = 0.35;
   splashSize = 0.1;
...
{
   filename = "art/Packs/Precip/rain/sound/thunder1";
   description = Audio2d;
};

datablock SFXProfile(ThunderCrash2Sound)
{
   filename = "art/Packs/Precip/rain/sound/thunder2";
   description = Audio2d;
};

datablock SFXProfile(ThunderCrash3Sound)
{
   filename = "art/Packs/Precip/rain/sound/thunder3";
   description = Audio2d;
};

datablock SFXProfile(ThunderCrash4Sound)
{
   filename = "art/Packs/Precip/rain/sound/thunder4";
   description = Audio2d;
};

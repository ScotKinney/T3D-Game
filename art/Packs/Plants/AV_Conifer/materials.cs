singleton Material(mat_Bush01_AV)
{
   mapTo = "Bush01";
   diffuseMap[0] = "BushLeaf01.dds";
   specular[0] = "0.698039 1 0 1";
   specularPower[0] = "1";
   ...
   alphaTest = "1";
   alphaRef = "174";
   normalMap[0] = "GreenBirch2_NRM.dds";
...
singleton Material(mat_LargeLeaf01_AV)
{
   ...
   translucentBlendOp = "LerpAlpha";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.529412 0.580392 0.0313726 1";
   alphaTest = "1";
   alphaRef = "30";

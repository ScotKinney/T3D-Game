...
function GargoyleDts::onLoad(%this)
{
   ...
   %this.addSequence("./gargoyle_death_1.dsq", "death4", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_death_2.dsq", "death5", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_air_death.dsq", "death6", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_death_1.dsq", "death7", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_death_2.dsq", "death8", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_air_death.dsq", "death9", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_death_1.dsq", "death10", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_death_2.dsq", "death11", "0", "-1", "1", "0");
   %this.addSequence("./gargoyle_air_death.dsq", "death12", "0", "-1", "1", "0");

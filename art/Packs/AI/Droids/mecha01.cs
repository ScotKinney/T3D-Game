...
function Mecha01Dts::onLoad(%this)
{
   ...
   %this.addSequence("art/Packs/AI/Droids/walk.dsq", "run", "0", "104");
   ...
   %this.addSequence("art/Packs/AI/Droids/straferight.dsq", "side", "0", "29");
   ...
   %this.addSequence("art/Packs/AI/Droids/backward.dsq", "back", "0", "10");
   %this.setSequenceCyclic("back", "0");
   %this.addSequence("art/Packs/AI/Droids/jump.dsq", "jump", "0", "29");

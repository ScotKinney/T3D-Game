...
function GTDts::onLoad(%this)
{
   ...
   %this.addSequence("./GT_SwordSwing1.dsq", "Attack1", "0", "19", "1", "0");
   %this.addSequence("./GT_SwordSwing2.dsq", "Attack2", "0", "19", "1", "0");
   %this.addSequence("./GT_SwordSwing3.dsq", "Attack3", "0", "19", "1", "0");
   %this.addSequence("./GT_SwordSwing4.dsq", "Attack4", "0", "19", "1", "0");

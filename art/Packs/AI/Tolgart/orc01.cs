...
function Orc01Dts::onLoad(%this)
{
   ...
   %this.addSequence("./orc_walk.dsq", "Walk", "0", "-1", "1", "0");
   %this.addSequence("./orc_walk.dsq", "Walk_Back", "0", "-1", "1", "0");
   %this.addSequence("./orc_strafeleft.dsq", "Strafe_Left", "0", "-1", "1", "0");
   %this.addSequence("./orc_death01.dsq", "death1", "0", "-1", "1", "0");
   %this.addSequence("./orc_death02.dsq", "death2", "0", "-1", "1", "0");
   %this.addTrigger("Walk", "0", "1");

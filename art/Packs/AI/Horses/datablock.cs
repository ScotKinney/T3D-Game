...
//----------------------------------------------------------------------------
datablock SFXProfile(HoofLightSoftSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_soft.ogg";
   description = AudioClosest3d;
   preload = true;
};

datablock SFXProfile(HoofLightHardSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_soft.ogg";
   description = AudioClose3d;
   preload = true;
...
datablock SFXProfile(HoofLightMetalSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_soft.ogg";
   description = AudioClose3d;
   preload = true;
...
datablock SFXProfile(HoofLightSnowSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_soft.ogg";
   description = AudioClosest3d;
   preload = true;
...
datablock SFXProfile(HoofLightShallowSplashSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_water.ogg";
   description = AudioClose3d;
   preload = true;
};

datablock SFXProfile(HoofLightWadingSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_water.ogg";
   description = AudioClose3d;
   preload = true;
...
datablock SFXProfile(HoofLightUnderwaterSound)
{
   filename    = "art/Packs/AI/Horses/sound/Hoof_water.ogg";
   description = AudioClosest3d;
   preload = true;
...
datablock SFXProfile(HoofLightBubblesSound)
{
   filename    = "art/sound/footsteps/water_wl1";
   description = AudioClose3d;
   preload = true;

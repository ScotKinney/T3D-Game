...
function ParasaurolophusDts::onLoad(%this)
{
   ...
   %this.addSequence("art/Packs/AI/Dinos/Parasaurolophus/parasaurolophus_run.dsq", "Walk", "0", "880");
   %this.setSequenceCyclic("Walk", "1");
   %this.addSequence("art/Packs/AI/Dinos/Parasaurolophus/parasaurolophus_sprint.dsq", "Run2", "0", "40");
   %this.setSequenceCyclic("Run2", "1");
   %this.addSequence("art/Packs/AI/Dinos/Parasaurolophus/parasaurolophus_back.dsq", "Walk_Back", "0", "20");
   %this.setSequenceCyclic("Walk_Back", "1");
   %this.addSequence("art/Packs/AI/Dinos/Parasaurolophus/parasaurolophus_side.dsq", "Strafe_Left", "0", "20");

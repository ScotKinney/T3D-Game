...
function SpinosaurusDts::onLoad(%this)
{
   ...
   %this.addSequence("art/Packs/AI/Dinos/Spinosaurus/spinosaurus_run.dsq", "Walk", "0", "880");
   %this.setSequenceCyclic("Walk", "1");
   %this.addSequence("art/Packs/AI/Dinos/Spinosaurus/spinosaurus_sprint.dsq", "Run2", "0", "40");
   %this.setSequenceCyclic("Run2", "1");
   %this.addSequence("art/Packs/AI/Dinos/Spinosaurus/spinosaurus_back.dsq", "Walk_Back", "0", "20");
   %this.setSequenceCyclic("Walk_Back", "1");
   %this.addSequence("art/Packs/AI/Dinos/Spinosaurus/spinosaurus_side.dsq", "Strafe_Left", "0", "20");

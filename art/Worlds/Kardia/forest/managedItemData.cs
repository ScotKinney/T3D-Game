...
datablock TSForestItemData(PalmTree_Short_01)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/trees/palm/palmtree_short.dae";
   branchAmp = "0.1";
   detailAmp = "0.15";
   detailFreq = "0.04";
...
datablock TSForestItemData(TallPalmLeaning)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/trees/palm/palmtree_tall_leaning.dae";
...
datablock TSForestItemData(palmtree_tall)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/trees/palm/palmtree_tall.dae";
trunkBendScale = "0.005";
   branchAmp = "0.2";
   detailAmp = "0.3";
   detailFreq = "0.02";
...
datablock TSForestItemData(BananaMature)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/trees/banana/bananatree_mature.DAE";
   radius = "1";
   trunkBendScale = "0.001";
   branchAmp = "0.04";
   detailAmp = "0.04";
...
datablock TSForestItemData(Palm_Bush)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/trees/palm/palm_bush.DAE";
   trunkBendScale = "0.01";
   branchAmp = "0.05";
   detailAmp = "0.08";
   detailFreq = "0.03";
...
datablock TSForestItemData(rivergrass0)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Plants/rivergrass/rivergrass.DAE";
   collidable = "0";
   rigidity = "1";
   windScale = "0.1";
   branchAmp = "1";
...
datablock TSForestItemData(CanopyTree_01_noVines)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Trees/Canopy/canopytree_one_novines.dae";
 windScale = "1";
   branchAmp = "0.03";
   detailAmp = "0.05";
   detailFreq = "0.1";
...
datablock TSForestItemData(canopytree_two)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Trees/Canopy/canopytree_two.dae";
windScale = "1";
   trunkBendScale = "0.005";
   branchAmp = "0.03";
   detailAmp = "0.07";
...
datablock TSForestItemData(canopytree_three)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Trees/Canopy/canopytree_three.dae";
   windScale = "1";
   trunkBendScale = "0.005";
   branchAmp = "0.03";
   detailAmp = "0.01";
...
datablock TSForestItemData(Shrub_Large)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Trees/Canopy/shrub_one.dae";
   collidable = "0";
   radius = "0.5";
   mass = "0.5";
   rigidity = "20";
...
datablock TSForestItemData(BigLeaf_Plant)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/plants/bigleaf/bigleaf.dae";
...
{
   internalName = "Bush2";
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Plants/Bush01/Bush01.DAE";
   windScale = "1";
   branchAmp = "0.02";
   detailAmp = "2";
   detailFreq = "0.05";
...
{
   internalName = "Phila2";
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Plants/Phila01/Phila01.DAE";
   radius = "0.5";
   windScale = "1";
   branchAmp = "0.02";
   detailAmp = "0.04";
...
datablock TSForestItemData(TropicFern2)
{
   ...
   shapeFile = "art/Packs/Worlds/Kardia/Forest/Plants/TropicFern/TropicFern01.DAE";
   radius = "0.5";
   windScale = "1";
   branchAmp = "0.02";
   detailAmp = "0.04";

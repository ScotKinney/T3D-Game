...
singleton Material(mat_MagellanAlpha)
{
   ...
   diffuseMap[0] = "art/Worlds/Magellan/Models/alpha_mat.dds";
   translucent = 1;
   ...
   normalMap[0] = "art/Worlds/Magellan/Models/alpha_matN.dds";
};
...
singleton Material(mat_MagellanMisc)
{
   ...
   diffuseMap[0] = "art/Worlds/Magellan/Models/misc.dds";
   specularMap[0] = "";
...
{
   mapTo = "_8_-_Default";
   diffuseMap[0] = "art/Worlds/Magellan/Models/walls.dds";
   normalMap[0] = "art/Worlds/Magellan/Models/wallsN.dds";
   materialTag0 = "Magellan";
   customFootstepSound = FootStepMetal1Sound;
   useAnisotropic[0] = "1";
};
...
singleton Material(Mat_TeleporterSign1)
{
   ...
   diffuseMap[0] = "art/Worlds/Magellan/Models/teleports.png";
   materialTag0 = "Magellan";
};
...
{
   mapTo = "PMat_srf4";
   diffuseMap[0] = "art/Worlds/Magellan/Models/teleportsSmallDown.png";
   materialTag0 = "Magellan";
};
...
singleton Material(Mat_tpSignLeft4)
{
   ...
   diffuseMap[0] = "art/Worlds/Magellan/Models/teleportsSmallLeft.png";
   materialTag0 = "Magellan";
};
...
{
   mapTo = "column2_d";
   diffuseMap[0] = "art/Worlds/Magellan/Models/column2_d.png";
   normalMap[0] = "art/Worlds/Magellan/Models/column2_n.png";
   materialTag0 = "Magellan";
};

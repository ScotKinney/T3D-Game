...
{
   fileName = "art/sound/PainDeathCries/GargoyleDeathCry";
...
{
   fileName = "art/sound/PainDeathCries/GargoylePainCry";
   description = AudioClosest3d;
   preload = false;
};
...
{
   fileName = "art/sound/footsteps/GargWing";
   description = AudioClosest3d;
   preload = false;
};
...
datablock PlayerData(IlluraGargoyle : DefaultPlayerData)
{
   ...
   className = Armor;
   shapeFile = $WorldPath @ "/AI/gargoyle/gargoyle.dts";

...
function basemale1_4Dts::onLoad(%this)
{
   ...
   %this.addSequence("art/players/base/Seqs/Bow/B_GetArrowFire.dsq", "B_GetArrow_Fire", "0", "124", "1", "0");
   %this.addTrigger("B_GetArrow_Fire", "94", "3");
   %this.addSequence("art/players/base/Seqs/Bow/B_Fire.dsq", "B_FireOnly", "0", "74", "1", "0");
   %this.addTrigger("B_FireOnly", "43", "3");
   ...
   %this.setSequenceBlend("TapLinkBlend", "0", "", "0");

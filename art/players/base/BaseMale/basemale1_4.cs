...
function basemale1_4Dts::onLoad(%this)
{
   ...
   %this.addNode("mount10", "rToe", "0 0 0 0 0 1 0", "0");
   %this.addNode("mount12", "lToe", "0 0 0 0 0 1 0", "0");
   ...
   %this.addSequence("art/players/base/Anims/RunFull_Root.dsq", "RunFull_Root", "0", "29", "1", "0");
   ...
   %this.addSequence("art/players/base/Anims/RunFull_Root.dsq", "Sprint_Root", "0", "29", "1", "0");
   %this.addSequence("art/players/base/Anims/Sprint_Forward.dsq", "Sprint_Forward", "0", "29", "1", "0");
   ...
   %this.addSequence("art/players/base/Anims/SprintFull_Forward.dsq", "SprintFull_Forward", "0", "59", "1", "0");
   ...
   %this.addSequence("art/players/base/Anims/Jump.dsq", "Jump", "0", "29", "1", "0");
   %this.addTrigger("jump", "16", "1");
   %this.addTrigger("jump", "16", "2");
   %this.addSequence("art/players/base/Anims/StandJump.dsq", "StandJump", "0", "29", "1", "0");
   ...
   %this.addSequence("art/players/base/Anims/JumpFull.dsq", "JumpFull", "0", "15", "1", "0");
   %this.addTrigger("jumpfull", "16", "1");
   %this.addTrigger("jumpfull", "16", "2");
   %this.addSequence("art/players/base/Anims/StandJumpFull.dsq", "StandJumpFull", "0", "15", "1", "0");

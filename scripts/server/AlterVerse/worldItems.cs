...
datablock ItemData(boartuskWeapon)
{
   pickupName = "Null";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/boartusk/boartusk.dae";
   invIcon = "art/gui/icons/spear.jpg";
   previewImage = "art/gui/icons/spear.jpg";
   maxInventory = 50;
   keepOnDeath = 0;
   skullLevel = 0;
   effect = "THROWN";
...
$BloodClans::ItemNames[49] = "boartuskWeapon";

datablock ItemData(boartuskAmmo)
{
   pickupName = "Null";
...
$BloodClans::ItemNames[50] = "boartuskAmmo";
...
datablock ItemData(BugClawWeapon)
{
   pickupName = "Club";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/BugClaw/bugclaw.dts";
   invIcon = "art/gui/icons/Sword.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 1;
   keepOnDeath = 1;
   skullLevel = 0;
   effect = "NONE";
...
$BloodClans::ItemNames[108] = "BugClawWeapon";

datablock ItemData(ClubWeapon)
{
   pickupName = "Club";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/club/club.dts";
   invIcon = "art/gui/icons/Sword.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 1;
   keepOnDeath = 1;
...
$BloodClans::ItemNames[107] = "ClubWeapon";

datablock ItemData(Comp_JawWeapon)
{
   pickupName = "Comp_Jaw";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/Comp_Jaw/Comp_Jaw.dts";
   invIcon = "art/gui/icons/sword.jpg";
...
$BloodClans::ItemNames[151] = "Comp_JawWeapon";
...
datablock ItemData(DracoSpitballWeapon)
{
   pickupName = "DracoSpitball";

   ItemID = 66;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/drac/dracofireball.dae";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 100;
   keepOnDeath = 0;
   ...
   indestructible = 0;
   ranged = 1;
   image = DracoSpitballImage;
   ammo = DracoSpitBallAmmo;
   effectWeap = "[THROWN]";
   skill_used = "Throwing";
   delay = 4;
   reticle = 'reticle_rocketlauncher';
...
$BloodClans::ItemNames[66] = "DracoSpitballWeapon";

datablock ItemData(DracoSpitballAmmo)
{
   pickupName = "DracoSpitball";
...
$BloodClans::ItemNames[67] = "DracoSpitballAmmo";

datablock ItemData(DroidGun5Weapon)
{
   pickupName = "DroidGun5";

   ItemID = 30;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/DroidGuns/gun05.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/ammo.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[30] = "DroidGun5Weapon";

datablock ItemData(DroidGun5Ammo)
{
   pickupName = "DroidGun5";
   ...
   category = "ammo";
   className = "ammo";
   shapeFile = "art/inv/weapons/DroidGuns/5_56.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/ammo.jpg";
   maxInventory = 999;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[31] = "DroidGun5Ammo";
...
datablock ItemData(F_HammerWeapon)
{
   pickupName = "f_hammer";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/f_hammer/f_hammer.dts";
   invIcon = "art/gui/icons/Sword.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 1;
   keepOnDeath = 1;
...
$BloodClans::ItemNames[121] = "F_HammerWeapon";

datablock ItemData(FireballWeapon)
{
   pickupName = "Fireball";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/LavaRock/LavaRock.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 50;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[44] = "FireballWeapon";

datablock ItemData(FireballAmmo)
{
   pickupName = "Fireball";
...
$BloodClans::ItemNames[45] = "FireballAmmo";
...
datablock ItemData(GargoyleFireballWeapon)
{
   pickupName = "GargoyleFireball";
   ...
   indestructible = 0;
   ranged = 1;
   image = GargoyleFireballImage;
   ammo = GargoyleFireballAmmo;
   effectWeap = "[THROWN]";
   skill_used = "Throwing";
   delay = 4;
   reticle = 'reticle_rocketlauncher';
...
$BloodClans::ItemNames[52] = "GargoyleFireballWeapon";

datablock ItemData(GargoyleFireballAmmo)
{
   pickupName = "GargoyleFireball";
...
$BloodClans::ItemNames[53] = "GargoyleFireballAmmo";
...
$BloodClans::ItemNames[42] = "HammerAmmo";
...
datablock ItemData(IceBallWeapon)
{
   pickupName = "IceBall";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/IceBall/IceBall.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[35] = "IceBallWeapon";

datablock ItemData(IceBallAmmo)
{
   pickupName = "IceBall";
...
$BloodClans::ItemNames[36] = "IceBallAmmo";
...
datablock ItemData(LeftFootWeapon)
{
   pickupName = "LeftFoot";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/H2H/lfoot.dts";
   invIcon = "art/gui/icons/h2h.jpg";
   previewImage = "art/gui/icons/h2h.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
   skullLevel = 0;
   effect = "NONE";
...
$BloodClans::ItemNames[149] = "LeftFootWeapon";

datablock ItemData(LeftHandWeapon)
{
   pickupName = "LeftHand";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/H2H/lhand.dts";
   invIcon = "art/gui/icons/h2h.jpg";
   previewImage = "art/gui/icons/h2h.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[148] = "LeftHandWeapon";
...
datablock ItemData(RightFootWeapon)
{
   pickupName = "RightFoot";

   ItemID = 150;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/H2H/rfoot.dts";
   invIcon = "art/gui/icons/h2h.jpg";
   previewImage = "art/gui/icons/h2h.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[150] = "RightFootWeapon";

datablock ItemData(RightHandWeapon)
{
   pickupName = "RightHand";

   ItemID = 147;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/H2H/rhand.dts";
   invIcon = "art/gui/icons/h2h.jpg";
   previewImage = "art/gui/icons/h2h.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[147] = "RightHandWeapon";
...
datablock ItemData(sharktoothWeapon)
{
   pickupName = "Sharks Tooth";
   pluralName = "Sharks Teeth";

   ItemID = 54;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/shark/sharktooth.dae";
   invIcon = "art/gui/icons/spear.jpg";
   previewImage = "art/gui/icons/spear.jpg";
   maxInventory = 100;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[54] = "sharktoothWeapon";

datablock ItemData(sharktoothAmmo)
{
   pickupName = "Sharks Tooth";
   pluralName = "Sharks Teeth";
...
$BloodClans::ItemNames[55] = "sharktoothAmmo";
...
datablock ItemData(TolgartsAxeWeapon)
{
   pickupName = "TolgartsAxe";

   ItemID = 57;
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/OgreAxe/tolgartsaxe.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/axe.jpg";
   maxInventory = 999;
   keepOnDeath = 0;
   ...
   indestructible = 0;
   ranged = 1;
   image = TolgartsAxeImage;
   ammo = TolgartsAxeAmmo;
   effectWeap = "[THROWN]";
   exclusive = " ";
   skill_used = "Throwing";
   delay = 4;
...
$BloodClans::ItemNames[57] = "TolgartsAxeWeapon";

datablock ItemData(TolgartsAxeAmmo)
{
   pickupName = "TolgartsAxe";
...
$BloodClans::ItemNames[58] = "TolgartsAxeAmmo";
...
datablock ItemData(WBHornsWeapon)
{
   pickupName = "Club";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/WB_Horns/wbhorns.dts";
   invIcon = "art/gui/icons/Sword.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 1;
   keepOnDeath = 1;
...
$BloodClans::ItemNames[143] = "WBHornsWeapon";
...
datablock ItemData(XR75Weapon)
{
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/droidguns/XR75.dts";
   invIcon = "art/gui/icons/xr75.jpg";
   previewImage = "art/gui/icons/xr75.jpg";
   maxInventory = 1;
   keepOnDeath = 0;
   skullLevel = 0;
   effect = "NONE";
...
$BloodClans::ItemNames[28] = "XR75Weapon";
...
$BloodClans::ItemNames[29] = "XRBoltsAmmo";

datablock ItemData(YetiRockWeapon)
{
   pickupName = "YetiRock";
   ...
   category = "weapons";
   className = "wpn";
   shapeFile = "art/inv/weapons/YetiRock/YetiRock.dts";
   invIcon = "art/gui/icons/wpn.jpg";
   previewImage = "art/gui/icons/wpn.jpg";
   maxInventory = 50;
   keepOnDeath = 0;
...
$BloodClans::ItemNames[37] = "YetiRockWeapon";

datablock ItemData(YetiRockAmmo)
{
   pickupName = "YetiRock";
...
$BloodClans::ItemNames[38] = "YetiRockAmmo";

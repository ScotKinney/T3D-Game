...
function TintTool::onWake(%this)
{
   ...
   %this.pendingCommand = "";
   %this.addedItems = "";
   %this.lastOverlayFile = "art/shapes/actors/tints/blue0.png";
   %this.UpdateState();
...
{  // Fill in all drop menus that contain fixed lists of options
   ...
   TintTool-->CatFilter.setSelected(0);
   ...
   TintTool-->SubFilter.setSelected(0);
   ...
   TintTool-->CategoryList.setSelected(0);
   ...
   TintTool-->SubCategoryList.setSelected(0);
   ...
   TintToolGenPage-->GenderList.setSelected(0);
   ...
   TintToolGenPage-->homeWorldList.setSelected(0);
}
...
function TintTool::initGeneralTab(%this, %itemDB)
{
   ...
   if ( "/" $= getSubStr(%overLayFile, 0, 1) )
      %overLayFile = "art/shapes/actors/tints" @ %overLayFile;
...
function TintTool::doUpdateQuery(%this, %newTint)
{
   ...
   %fullQuery = "Update AVTints Set " @ %queryStr @ " Where ID='" @ %this.curItemID @ "'";
...
function TintTool::makeQSGeneralTab(%this, %itemDB, %queryStr)
{
   ...
   {
      %testVal = strreplace(%testVal, "art/shapes/actors/tints", "");
